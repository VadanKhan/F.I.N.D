...
class RpsStatic(FailureModeChecker):
    def _rps_static_checker(self, rps_data: np.ndarray, eol_test_id, test_type):
        ...
        This function takes a NumPy array containing RPS data, a test_type, and an eol_test_id as input and returns two
            ...
            each sensor is within a normal range, and the second list indicates whether the differential RMS value of
            each sensor is above a certain threshold.
    ...
    def analyse(self):
        ...
        return self._rps_static_checker(rps_data, self.eol_test_id, self.test_type)
